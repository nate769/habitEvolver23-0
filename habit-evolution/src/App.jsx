...
function App({ baseUrl = '/' }) {
  ...
  const [goals, setGoals] = useState([
    { text: 'Wake up at 5:00 AM', date: '', completed: false, taskStreak: 0 },
    { text: 'Go to the gym', date: '', completed: false, taskStreak: 0 },
    { text: 'Solve 5 Codeforces problems', date: '', completed: false, taskStreak: 0 }
  ]);
